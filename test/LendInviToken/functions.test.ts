...
describe("LendingPool functions test", function () {
  ...
  this.beforeEach(async () => {
    return [stKlayContract, inviCoreContract, iLPTokenContract, stakeNFTContract, inviTokenContract, lpPoolContract, inviTokenStakeContract, LendingPoolContract] = await deployAllWithSetting();
  });
