...
describe("Invi core service test", function () {
  ...
  it("Test reward function", async () => {
    ...
    const unstakeRequestAmount = await inviCoreContract.connect(userA).unstakeRequestAmount();
    ...
    // step 10. Stake Again for 10 times
    console.log("===Step 10");
    // user A
    for (let i = 0; i < 5; i++) {
    ...
    // Step 11. Give Rewards to inviCore
    console.log("===Step 11");
    ...
    console.log("stakeInfoNftBefore : ", stakeInfoNft2.toString());
    console.log("stakeInfoNftAfter  : ", stakeInfoNft3.toString());
  });
});
