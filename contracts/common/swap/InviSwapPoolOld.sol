...
//  */
// contract InviSwapPoolOld is Initializable, OwnableUpgradeable {
...
//     function getAddLiquidityInvi(uint _amountIn) public view returns (uint256) {
//         uint256 currentNativePrice = priceManager.getNativePrice();
//         uint256 currentInviPrice = priceManager.getInviPrice();
//         return uint256(_amountIn * currentNativePrice / currentInviPrice);
//     }
