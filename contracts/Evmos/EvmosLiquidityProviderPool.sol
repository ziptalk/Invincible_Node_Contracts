...
import "./EvmosInviCore.sol";

contract EvmosLiquidityProviderPool is Initializable, OwnableUpgradeable {
    //------Contracts and Addresses------//
    IERC20 public iLP;
    IERC20 public inviToken;
    EvmosInviCore public inviCoreContract;
    ...
    function setInviCoreContract(address payable _inviCore) external onlyOwner {
        inviCoreContract = EvmosInviCore(_inviCore);
    }
